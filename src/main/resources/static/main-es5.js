...
var DashboardFirstComponent = /** @class */ (function () {
    function DashboardFirstComponent(el, renderer2, http) {
        this.el = el;
        this.renderer2 = renderer2;
        this.http = http;
    }
    DashboardFirstComponent.prototype.ngAfterViewInit = function () {
        /*告警数据*/
    ...
    DashboardFirstComponent.prototype.ngOnInit = function () {
    };
    /*地图*/
    DashboardFirstComponent.prototype.getDitu = function () {
        var _this = this;
            ...
            tooltip: {
                ...
                formatter: function (p) {
                    ...
                    if (dataCon.warn !== undefined) {
                        var ip = dataCon.warn.split(',');
                        var s = dataCon.name + "</br>IP:";
                        try {
                            for (var ip_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](ip), ip_1_1 = ip_1.next(); !ip_1_1.done; ip_1_1 = ip_1.next()) {
                                var i = ip_1_1.value;
                                s += "</br>" + i;
                            }
                        }
                            ...
                            try {
                                if (ip_1_1 && !ip_1_1.done && (_a = ip_1.return)) _a.call(ip_1);
                            }
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/info/ipAddress').subscribe(function (req) {
            ...
            _this.myChartMapOption.setOption({
                series: [{
            ...
            _this.myChartMapOption.hideLoading();
        });
    };
    /*获取警告数据*/
    DashboardFirstComponent.prototype.aletDistributeSet = function () {
        var _this = this;
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/info/threatNum').subscribe(function (req) {
            if (req.data != null) {
                _this.notHandleNum = req.data[0].notHandleNum;
                _this.handledNum = req.data[0].handledNum;
                _this.threatNum = req.data[0].threatNum;
            }
        });
    };
    /* 获取报文数据*/
    DashboardFirstComponent.prototype.AaptureMessageSet = function () {
        var _this = this;
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/info/packageNum', params).subscribe(function (req) {
            var e_5, _a;
            if (req.data != null) {
                var yAaptureData = [];
                var xAaptureData = [];
                try {
                    for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](req.data), _c = _b.next(); !_c.done; _c = _b.next()) {
                        ...
                        var day = moment__WEBPACK_IMPORTED_MODULE_3__(Number(i.time)).format('MM-DD HH:mm:ss');
            ...
            _this.myChartAapure.hideLoading();
        });
    };
    /* 获取检测流量数据*/
    DashboardFirstComponent.prototype.DetectFlowSet = function () {
        var _this = this;
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/info/flowNum', params).subscribe(function (req) {
            var e_6, _a;
            if (req.data != null) {
                var yDetectFlowData = [];
                var xDetectFlowData = [];
    ...
    /*获取木马ip访问统计排名*/
    DashboardFirstComponent.prototype.TopSelectSet = function () {
        var _this = this;
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/info/trojanIpCount', params).subscribe(function (req) {
            var e_7, _a;
            if (req.data != null) {
                var xData = [];
                var yData = [];
                ...
                _this.myChartTriIPOption.setOption({
                    yAxis: {
                        data: yData.reverse(),
                    },
                    series: [{
            ...
            _this.myChartTriIPOption.hideLoading();
        });
    };
    /* dnsIP 访问统计*/
    DashboardFirstComponent.prototype.DnsTopSelectSet = function () {
        var _this = this;
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/info/dnsIpCount', params).subscribe(function (req) {
            var e_8, _a;
            if (req.data != null) {
                var xData = [];
                var yData = [];
                ...
                _this.myChartDNSIPOption.setOption({
                    yAxis: {
                        data: yData.reverse(),
                    },
                    series: [{
            ...
            _this.myChartDNSIPOption.hideLoading();
        });
    };
    /* 威胁等级饼图等级*/
    DashboardFirstComponent.prototype.getDns = function () {
        var _this = this;
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/info/threatLevel').subscribe(function (req) {
            var e_9, _a;
            if (req.data != null) {
                var xData = [];
                var yData = [];
                ...
                _this.myChartDnsOption.setOption({
                    legend: {
            ...
            _this.myChartDnsOption.hideLoading();
        });
    };
    /*  威胁等级堆叠柱状图*/
    DashboardFirstComponent.prototype.getThrenOption = function () {
        var _this = this;
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/info/threatLevelNum').subscribe(function (req) {
            var e_10, _a;
            if (req.data != null) {
                var xData = [];
                var yData1 = [];
                ...
                _this.myChartThrenOption.setOption({
                    legend: {
                        data: ['木马', 'DNS'],
                    },
                    xAxis: [
            ...
            _this.myChartThrenOption.hideLoading();
        });
    };
    DashboardFirstComponent.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"] },
    ...
    return DashboardFirstComponent;
}());
...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'horse', loadChildren: function () { return __webpack_require__.e(/*! import() | horse-horse-module */ "horse-horse-module").then(__webpack_require__.bind(null, /*! ./horse/horse.module */ "./src/app/routes/horse/horse.module.ts")).then(function (m) { return m.HorseModule; }); } },
            { path: 'dns', loadChildren: function () { return __webpack_require__.e(/*! import() | dns-dns-module */ "dns-dns-module").then(__webpack_require__.bind(null, /*! ./dns/dns.module */ "./src/app/routes/dns/dns.module.ts")).then(function (m) { return m.DnsModule; }); } },
...
/* harmony import */ var angular_baidu_maps__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! angular-baidu-maps */ "./node_modules/angular-baidu-maps/fesm5/angular-baidu-maps.js");
