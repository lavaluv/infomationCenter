...
let DnsDetectionComponent = class DnsDetectionComponent {
    constructor(http, fb) {
        this.http = http;
        this.fb = fb;
    ...
    getData() {
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/dectDns', params).subscribe((req) => {
            if (req.data != null) {
...
DnsDetectionComponent.ctorParameters = () => [
...
let DnsRoutingModule = class DnsRoutingModule {
};
...
let DnsHistoryComponent = class DnsHistoryComponent {
    constructor(http, fb) {
        this.http = http;
        this.fb = fb;
        this.listOfDisplayData = [];
    ...
    getLine() {
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/historyView', params).subscribe((req) => {
            if (req.data != null) {
                for (const i of req.data) {
                    const day = moment__WEBPACK_IMPORTED_MODULE_5__(Number(i.date)).format('MM-DD HH:mm:ss');
    ...
    getDomain() {
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/countAllDomain', param).subscribe((req) => {
            if (req.data !== null) {
                for (const i of req.data) {
    ...
    getdata() {
        ...
        this.http.get(_env_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].PUBLIC_URL + '/detail', params1).subscribe((req) => {
            if (req.data != null) {
                this.listOfDisplayData = req.data[0].content;
...
DnsHistoryComponent.ctorParameters = () => [
    { type: _delon_theme__WEBPACK_IMPORTED_MODULE_2__["_HttpClient"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] }
];
...
//# sourceMappingURL=dns-dns-module-es2015.js.map